...
{
    /// <summary>
    ///     Used to processes strain values of <see cref="DifficultyHitObject" />s, keep track of strain levels caused by the
    ///     processed objects
    ...
    {
        /// <summary>
        ///     Strain values are multiplied by this number for the given skill. Used to balance the value of different skills
        ///     between each other.
        /// </summary>
        ...
        {
            if (current.Index == 0) return CurrentStrain;
        ...
        /// <summary>
        ///     Calculates the strain value of a <see cref="DifficultyHitObject" />. This value is affected by previously processed
        ///     objects.
        /// </summary>
