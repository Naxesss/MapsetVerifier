...
namespace MapsetVerifier.Parser.StarRating.Skills
{
    ...
    public abstract class StrainSkill : Skill
    {
        ...
        /// <summary>
        ///     Returns the strain value at <see cref="DifficultyHitObject" />. This value is calculated with or without respect to
        ///     previous objects.
        /// </summary>
        ...
        /// <summary>
        ///     Saves the current peak strain level to the list of strain peaks, which will be used to calculate an overall
        ///     difficulty.
        /// </summary>
