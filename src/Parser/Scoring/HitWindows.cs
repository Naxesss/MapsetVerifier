...
namespace MapsetVerifier.Parser.Scoring
{
    ...
    public class HitWindows
    {
        ...
        public void SetDifficulty(double difficulty)
        {
            ...
            {
                var value = DifficultySettings.DifficultyRange(difficulty, (range.Min, range.Average, range.Max));
        ...
        /// <returns>
        ///     The hit result, or <see cref="HitResult.None" /> if <paramref name="timeOffset" /> doesn't result in a
        ///     judgement.
        /// </returns>
        ...
        ///     This is the number of +/- milliseconds allowed for the requested result (so the actual hittable range is double
        ///     this).
        /// </summary>
        ...
        /// <summary>
        ///     Given a time offset, whether the <see cref="HitObject" /> can ever be hit in the future with a non-
        ///     <see cref="HitResult.Miss" /> result.
        ///     This happens if <paramref name="timeOffset" /> is less than what is required for
        ///     <see cref="LowestSuccessfulHitResult" />.
        /// </summary>
        /// <param name="timeOffset">The time offset.</param>
