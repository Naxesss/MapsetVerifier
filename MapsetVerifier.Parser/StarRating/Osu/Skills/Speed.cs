...
{
    /// <summary>
    ///     Represents the skill required to press keys with regards to keeping up with the speed at which objects need to be
    ///     hit.
    /// </summary>
    public class Speed : StrainDecaySkill
    {
        ...
        protected override double StrainValueOf(DifficultyHitObject current)
        {
            ...
            var distance = Math.Min(single_spacing_threshold, osuCurrent.TravelDistance + osuCurrent.JumpDistance);
            var deltaTime = Math.Max(max_speed_bonus, current.DeltaTime);
