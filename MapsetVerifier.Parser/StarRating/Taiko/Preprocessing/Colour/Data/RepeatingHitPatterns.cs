...
namespace MapsetVerifier.Parser.StarRating.Taiko.Preprocessing.Colour.Data
{
    ...
    ///     <see cref="AlternatingMonoPattern" />. Also stores the repetition interval between this and the previous
    ...
    public class RepeatingHitPatterns
    {
        ...
        public RepeatingHitPatterns(RepeatingHitPatterns? previous) => Previous = previous;
        ...
        /// <summary>
        ///     How many <see cref="RepeatingHitPatterns" /> between the current and previous identical
        ///     <see cref="RepeatingHitPatterns" />.
        ...
        private bool isRepetitionOf(RepeatingHitPatterns other)
        {
            ...
            for (var i = 0; i < Math.Min(AlternatingMonoPatterns.Count, 2); i++)
                if (!AlternatingMonoPatterns[i].HasIdenticalMonoLength(other.AlternatingMonoPatterns[i]))
                    return false;
        ...
        /// <summary>
        ///     Finds the closest previous <see cref="RepeatingHitPatterns" /> that has the identical
        ///     <see cref="AlternatingMonoPatterns" />.
        ///     Interval is defined as the amount of <see cref="RepeatingHitPatterns" /> chunks between the current and repeated
        ///     patterns.
        /// </summary>
