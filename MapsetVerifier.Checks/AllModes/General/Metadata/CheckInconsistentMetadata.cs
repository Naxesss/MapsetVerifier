...
namespace MapsetVerifier.Checks.AllModes.General.Metadata
{
    ...
    public class CheckInconsistentMetadata : GeneralCheck
    {
            ...
            foreach (var beatmap in beatmapSet.Beatmaps)
            {
                ...
                issues.AddRange(
                    GetInconsistency(
                        ...
                        beatmap,
                        refBeatmap,
                        otherBeatmap => otherBeatmap.MetadataSettings.artist
                    )
                );
                ...
                issues.AddRange(
                    GetInconsistency(
                        ...
                        beatmap,
                        refBeatmap,
                        otherBeatmap => otherBeatmap.MetadataSettings.artistUnicode
                    )
                );
                ...
                issues.AddRange(
                    GetInconsistency(
                        ...
                        beatmap,
                        refBeatmap,
                        otherBeatmap => otherBeatmap.MetadataSettings.title
                    )
                );
                ...
                issues.AddRange(
                    GetInconsistency(
                        ...
                        beatmap,
                        refBeatmap,
                        otherBeatmap => otherBeatmap.MetadataSettings.titleUnicode
                    )
                );
                ...
                issues.AddRange(
                    GetInconsistency(
                        ...
                        beatmap,
                        refBeatmap,
                        otherBeatmap => otherBeatmap.MetadataSettings.source
                    )
                );
                ...
                issues.AddRange(
                    GetInconsistency(
                        ...
                        beatmap,
                        refBeatmap,
                        otherBeatmap => otherBeatmap.MetadataSettings.creator
                    )
                );
                ...
                var differenceTags = refTags
                    .Except(curTags)
                    .Union(curTags.Except(refTags))
                    .Distinct();
        ...
        private IEnumerable<Issue> GetInconsistency(
            ...
            Func<Beatmap, string> metadataField
        )
        {
