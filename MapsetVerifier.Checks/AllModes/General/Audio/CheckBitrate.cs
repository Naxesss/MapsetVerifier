    ...
    public class CheckBitrate : GeneralCheck
    {
        ...
        public override Dictionary<string, IssueTemplate> GetTemplates() =>
            new()
            {
                {
                    "Bitrate",
                    new IssueTemplate(Issue.Level.Problem, "Average audio bitrate for \"{0}\", {1} kbps, is too {2}.", "path", "bitrate", "high/low").WithCause("The average bitrate of an audio file is either higher than 192/208 kbps" + "for MP3/OGG respectively or lower than 128 kbps.")
                },

                {
                    "Hit Sound",
                    new IssueTemplate(Issue.Level.Warning, "Average audio bitrate for \"{0}\", {1} kbps, is really low.", "path", "bitrate").WithCause("Same as the other check, except only applies to hit sounds using the lower threshold.")
                },
