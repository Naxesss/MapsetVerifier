    ...
    public class CheckHitSoundFormat : GeneralCheck
    {
        ...
        public override Dictionary<string, IssueTemplate> GetTemplates() =>
            new()
            {
                ...
                {
                    "Unexpected Format",
                    new IssueTemplate(Issue.Level.Warning, "\"{0}\" is using an unexpected format: \"{1}\".", "path", "actual format")
                        .WithCause("A hit sound file is using a format which is neither OGG, Wave, or MP3.")
                },

                {
                    "Incorrect Extension",
                    new IssueTemplate(Issue.Level.Warning, "\"{0}\" is using the {1} format, but doesn't use the .wav or .ogg extension.", "path", "actual format")
                        .WithCause("A hit sound file is using an incorrect extension.")
                },
